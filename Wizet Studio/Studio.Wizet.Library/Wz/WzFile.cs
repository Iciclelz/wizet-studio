...
namespace Studio.Wizet.Library.Wz
{
	/// <summary>
	...
	public class WzFile : IWzObject/*IWzFile*/
	{
		...
		internal void ParseMainWzDirectory()
		{
			...
			WzBinaryReader reader = new WzBinaryReader(File.Open(this.path, FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite), WzIv);
		...
		public void SaveToDisk(string path)
		{
			...
			Header.FSize = (ulong)(totalLen - Header.FStart);
			for (int i = 0; i < 4; i++)
            {
            ...
            long extraHeaderLength = (long)((ulong)Header.FStart - (ulong)wzWriter.BaseStream.Position);
