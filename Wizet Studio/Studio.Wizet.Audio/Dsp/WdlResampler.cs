...
// originally written in C++ and ported to C# for Studio.Wizet.Audio by Mark Heath
// Used in Studio.Wizet.Audio with permission from Justin Frankel
...
namespace Studio.Wizet.Audio.Dsp
{
    /// <summary>
