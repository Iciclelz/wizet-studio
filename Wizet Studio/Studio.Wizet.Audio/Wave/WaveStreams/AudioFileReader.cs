using System;
using Studio.Wizet.Audio.Wave.SampleProviders;

namespace Studio.Wizet.Audio.Wave
{
    /// <summary>
    /// AudioFileReader simplifies opening an audio file in Studio.Wizet.Audio
    ...
    public class AudioFileReader : WaveStream, ISampleProvider
    {
        ...
        /// <summary>
        /// Creates the reader stream, supporting all filetypes in the core Studio.Wizet.Audio library,
