using System;
using Studio.Wizet.Audio.Wave.Asio;
...
namespace Studio.Wizet.Audio.Wave
{
    ...
    public class AsioOut : IWavePlayer
    {
        ...
        /// n.b. Future Studio.Wizet.Audio may modify this
        /// </summary>
        ...
        /// </summary>
        [Obsolete("this function will be removed in a future Studio.Wizet.Audio as ASIO does not support setting the volume on the device")]
        public float Volume
        {
            get
            {
