...
namespace Studio.Wizet.Audio.Wave
{
    /// <summary>
    ...
    public class WaveBuffer : IWaveBuffer
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Studio.Wizet.Audio.Wave.WaveBuffer"/> to <see cref="System.Byte"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Studio.Wizet.Audio.Wave.WaveBuffer"/> to <see cref="System.Single"/>.
        /// </summary>
        /// <param name="waveBuffer">The wave buffer.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Studio.Wizet.Audio.Wave.WaveBuffer"/> to <see cref="System.Int32"/>.
        /// </summary>
        /// <param name="waveBuffer">The wave buffer.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Studio.Wizet.Audio.Wave.WaveBuffer"/> to <see cref="System.Int16"/>.
        /// </summary>
        /// <param name="waveBuffer">The wave buffer.</param>
        /// <returns>The result of the conversion.</returns>
