...
namespace Studio.Wizet.Audio.Wave.Compression
{
    /// <summary>
    ...
    class AcmInterop
    {
        ...
        public static extern MmResult acmFormatSuggest(
            IntPtr hAcmDriver,
            [In, MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Studio.Wizet.Audio.Wave.WaveFormatCustomMarshaler")] 
            WaveFormat sourceFormat,
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Studio.Wizet.Audio.Wave.WaveFormatCustomMarshaler")] 
